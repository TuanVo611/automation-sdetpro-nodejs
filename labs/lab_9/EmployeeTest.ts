...
const CTE1 = new CTE("Contract Employee 1", 10000);
const CTE2 = new CTE("Contract Employee 2", 20000);
const FTE1 = new FTE("Fulltime Employee 1", 30000);
const FTE2 = new FTE("Fulltime Employee 2", 40000);
